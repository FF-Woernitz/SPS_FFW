...
// INPUT ==>
// PIN_IN
const uint8_t INPUT_LIGHT_INSIDE_ON = CONTROLLINO_I16;
const uint8_t INPUT_LIGHT_INSIDE_OFF = CONTROLLINO_I17;
// <== INPUT

// OUTPUT ==>
// PIN_OUT DEFAULT
const uint8_t OUTPUT_HEATING_FRONT[2] = {CONTROLLINO_D21, 0};
const uint8_t OUTPUT_HEATING_BACK[2]  = {CONTROLLINO_D22, 0};
const uint8_t OUTPUT_AUDIO[2]  = {CONTROLLINO_D20, 0};
// <== OUTPUT