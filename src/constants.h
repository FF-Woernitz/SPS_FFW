...
const uint8_t LIGHT_MAIN_IN = CONTROLLINO_I16;
const uint8_t LIGHT_MAIN_OUT = CONTROLLINO_D22;
const uint8_t LIGHT_MAIN_PUSH = 1;
const uint8_t LIGHT_OUTSIDE_IN = CONTROLLINO_I17;
const uint8_t LIGHT_OUTSIDE_OUT = CONTROLLINO_D23;
