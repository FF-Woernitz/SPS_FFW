...
// LIGHT ==>
const uint8_t LIGHT_BLINK_COUNT = 3;
const uint8_t LIGHT_BLINK_DELAY = 300;

// PIN_IN PIN_OUT MODE
const uint8_t LIGHT_MAIN_CONFIG[3] = {CONTROLLINO_I16, CONTROLLINO_D22, 2};
const uint8_t LIGHT_OUTSIDE_CONFIG[3] = {CONTROLLINO_I17, CONTROLLINO_D23, 1};
// <== LIGHT
